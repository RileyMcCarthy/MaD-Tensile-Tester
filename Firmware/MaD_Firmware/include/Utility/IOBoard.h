...
#define DISTANCE_LIMIT_MAX GPI6_PIN_NUMBER
#define DISTANCE_LIMIT_MAX_REGISTER GPI6_PIN_REGISTER

#define DISTANCE_LIMIT_MIN GPI7_PIN_NUMBER
#define DISTANCE_LIMIT_MIN_REGISTER GPI7_PIN_REGISTER

#define ESD_LIMIT_MIN_PIN_NUMBER GPI9_PIN_NUMBER
#define ESD_LIMIT_MIN_PIN_REGISTER GPI9_PIN_REGISTER

#define ESD_LIMIT_MAX_PIN_NUMBER GPI10_PIN_NUMBER
#define ESD_LIMIT_MAX_PIN_REGISTER GPI10_PIN_REGISTER
