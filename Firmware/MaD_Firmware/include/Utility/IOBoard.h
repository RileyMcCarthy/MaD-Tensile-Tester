...
#define SWITCHED_POWER_PIN GPI1_PIN_NUMBER
#define SWITCHED_POWER_REGISTER GPI1_PIN_REGISTER

#define DISTANCE_LIMIT_MAX GPI2_PIN_NUMBER
#define DISTANCE_LIMIT_MAX_REGISTER GPI2_PIN_REGISTER

#define DISTANCE_LIMIT_MIN GPI3_PIN_NUMBER
#define DISTANCE_LIMIT_MIN_REGISTER GPI3_PIN_REGISTER

#define ESD_ACTIVE_PIN GPI4_PIN_NUMBER
#define ESD_ACTIVE_REGISTER GPI4_PIN_REGISTER

#define PIN_SRVORDY_PIN GPI5_PIN_NUMBER
#define PIN_SRVORDY_REGISTER GPI5_PIN_REGISTER
